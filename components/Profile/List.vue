...
<style scoped>
.item {
	@apply text-primary dark:text-darkSecondary grid grid-cols-4 rounded hover:bg-darkSecondary dark:hover:bg-black w-full p-2 cursor-pointer;
}
.flip-hover {
	@apply hover:bg-darkSecondary dark:hover:bg-darkBg trans;
}
</style>
